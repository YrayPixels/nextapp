...
function StudentsList(props) {
    ...
    const fetchFillables = () => {
        ...
        const allPrograms = `${process.env.NEXT_PUBLIC_API_BASE}admin/getAllProgrammes`
        const allDept = `${process.env.NEXT_PUBLIC_API_BASE}center/GetCourseByCenterId/${details.id}`
    ...
    function filterStud(std_id, filterby) {
        if (filterby == 'program') {
            var config = {
                method: 'get',
                url: `${process.env.NEXT_PUBLIC_API_BASE}GetAllStudentsByProgrammeId/${std_id}`,
                headers: {
            ...
            var config = {
                method: 'get',
                url: `${process.env.NEXT_PUBLIC_API_BASE}viewRegisteredStudentByModule/`,
                headers: {
                    'Authorization': `Bearer ${bearer}`,
                    "Content-Type": "application/x-www-form-urlencoded",
                },
            ...
            var config = {
                method: 'get',
                url: `${process.env.NEXT_PUBLIC_API_BASE}GetAllStudentsByFacultyId/${std_id}`,
                headers: {
                    'Authorization': `Bearer ${bearer}`,
                    "Content-Type": "application/x-www-form-urlencoded",
                },
    ...
    var config = {
        method: 'get',
        url: `${process.env.NEXT_PUBLIC_API_BASE}center/GetStudentByCenterId/${details.id}`,
        headers: {
            'Authorization': `Bearer ${bearer}`,
            "Content-Type": "application/x-www-form-urlencoded",
        },
    ...
    function deleteStud(param) {
        ...
        const deleteStudent = async () => {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}center/HideStudent/${param}`, requestOptions)
